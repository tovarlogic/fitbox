...
class Migration_lib
{
    ...
    function create_empty_file($name) 
    {
        ...
        $path = $this->_ci->config->item('migration_path').'/'.$timestamp."_"."$name.php";
...
//->dbforge->create_table('table_name', FALSE, $attributes);
...
// );
//->dbforge->add_column('table_name', $fields);
...
//         ),
// );
//->dbforge->modify_column('table_name', $fields);
...
class Migration_$name extends CI_Migration 
{
    ...
    public function down() 
    {
        ...
        echo "migration file for ".$name." has successfully been created." . PHP_EOL;
    }
