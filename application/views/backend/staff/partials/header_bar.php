        ...
        <div class="mobile-menu">
            ...
            <div class="collapse mobile-navbar" id="mobile-collapse">
                <ul class="nav navbar-nav">
                    <li>
                        <a href="<?php echo base_url(); ?>staff/profile" class="html5history"><i class="pe-7s-id"></i> Mi cuenta</a>
                    </li>
                    <li>
                    ...
                    <li>
                        <a href="<?php echo base_url(); ?>select" ><i class="pe-7s-users"></i> Cambiar tipo de perfil</a>
                    </li>
                    <?php endif; ?>
                    <li>
