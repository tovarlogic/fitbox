            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo ($action == 'add') ? form_open("athlete/height/add/") : form_open("athlete/height/edit/".$id); ?>
                            <div class ="row">
                              <div class="form-group col-md-4"><label>Fecha</label> <?php echo form_input($date);?></div>
                            </div>
                            <div class ="row">
                              <div class="form-group col-md-4"><label>Altura (cms)</label> <?php echo form_input($height);?></div>
                            </div>                        
