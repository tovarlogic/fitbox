<div id="header">
    ...
    <nav role="navigation">
        ...
        <div class="small-logo">
            <span class="text-primary">FITBOX</span>
        </div>
            ...
            <ul class="nav navbar-nav no-borders">
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu hdropdown notification animated fadeIn">
                        <!-- <li>
                            <a href="<?php echo base_url(); ?>athlete/account/profile" class="html5history">Cuenta</a>
                        </li>
                        <li>
                            <a href="<?php echo base_url(); ?>athlete/account/memberships" class="html5history">Planes contratados</a>
                        </li>-->
                        <li>
