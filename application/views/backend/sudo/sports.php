                    ...
                    <div class="col-sm-12">
                      ...
                      <table id="table1" class="footable table table-stripped toggle-arrow-tiny table-hover" data-page-size="20" data-filter=#filter>
                        ...
                        <tbody>
                          <?php $rows = 0;
                          if(sizeof($sports) > 0):
                            foreach($sports as $spr): 
                              $rows++; if ($rows % 2 == 0) {$class ='even';}else{$class ='odd';}?>
                            <tr class=<?php echo $class; ?> role="row">
                                <td class=""><?php echo $spr->name;?></td>
                                <td>
                                  <a href='<?php echo base_url(); ?>sudo/sport/edit/<?php echo $spr->id; ?>' type="button" class="btn btn-warning btn-xs html5history"><i class='fa fa-pencil'></i></a>
                                  <a href='<?php echo base_url(); ?>sudo/deleteSport/<?php echo $spr->id; ?>' type="button" class="btn btn-danger btn-xs html5history_warning"><i class='fa fa-trash-o'></i></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                          <?php endif ?>
