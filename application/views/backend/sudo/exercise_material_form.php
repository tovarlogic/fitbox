              ...
              <div class="panel-body">
                  <div id="hbreadcrumb" class="pull-right">
                      <ol class="hbreadcrumb breadcrumb">
                          ...
                          <li>Ejercicios</li>
                          <li>
                              <span><a href='<?php echo base_url(); ?>sudo/exercise_materials' class='html5history'>Materiales</a></span>
                          </li>
                          <li class="active">
            ...
            <div class="col-lg-12">
                <div class="hpanel">
                    ...
                    <div class="panel-body">
                        ...
                        <?php echo ($action == 'add') ? form_open("sudo/exercise_material/add/") : form_open("sudo/exercise_material/edit/".$id); ?>
                            <div class ="row">
...
<script>
  ...
  $('form').submit(function(e) {
    var form = $(this);
    var url2 = "<?php echo base_url("sudo/exercise_materials"); ?>";
    e.preventDefault();
    $.ajax({
        type: "POST",
