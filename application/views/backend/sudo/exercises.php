            ...
            <div class="hpanel">
              <div class="panel-heading">
                  <div class="pull-right">
                    <a href='<?php echo base_url(); ?>sudo/exercise/add' class="btn btn-info btn-primary html5history"><i class="fa fa-plus"></i></a>
                </div>
                  <?php echo $page_title;?>
              </div>
              <div class="panel-body">
                        ...
                        <tbody>
                          ...
                          if(sizeof($exercises) > 0):
                            ...
                            <tr class=<?php echo $class; ?> role="row">
                                <td class=""><?php echo $ex->name;?></td>
                                <td class=""><?php echo $ex->short_name;?></td>
                                <td>
                                  <a href='<?php echo base_url(); ?>sudo/exercise/edit/<?php echo $ex->id; ?>' type="button" class="btn btn-warning btn-xs html5history"><i class='fa fa-pencil'></i></a>
                                  <a href='<?php echo base_url(); ?>sudo/deleteExercise/<?php echo $ex->id; ?>' type="button" class="btn btn-danger btn-xs html5history_warning"><i class='fa fa-trash-o'></i></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                          <?php endif ?>
