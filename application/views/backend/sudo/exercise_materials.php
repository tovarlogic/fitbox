            ...
            <div class="hpanel">
              <div class="panel-heading">
                  <div class="pull-right">
                    <a href='<?php echo base_url(); ?>sudo/material/add' class="btn btn-info btn-primary html5history"><i class="fa fa-plus"></i></a>
                </div>
                  <?php echo $page_title;?>
              </div>
              <div class="panel-body">
                        ...
                        <tbody>
                          ...
                          if(sizeof($materials) > 0):
                            ...
                            <tr class=<?php echo $class; ?> role="row">
                                <td class=""><?php echo $mat->name;?></td>
                                <td class=""><?php echo $mat->short_name;?></td>
                                <td>
                                  <a href='<?php echo base_url(); ?>sudo/exercise_material/edit/<?php echo $mat->id; ?>' type="button" class="btn btn-warning btn-xs html5history"><i class='fa fa-pencil'></i></a>
                                  <a href='<?php echo base_url(); ?>sudo/deleteExerciseMaterial/<?php echo $mat->id; ?>' type="button" class="btn btn-danger btn-xs html5history_warning"><i class='fa fa-trash-o'></i></a>
                                </td>
                            </tr>
                            <?php endforeach ?>
                          <?php endif ?>
