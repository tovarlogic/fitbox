 ...
 */
$config['site_title']                 = "Fitbox.es";       // Site Title, example.com
$config['admin_email']                = "info@fitbox.es"; // Admin Email, admin@example.com
...
$config['user_expire']                = 15*24*60*60; //15 days      // How long to remember the user (seconds). Set to zero for no expiration
...
$config['lockout_time']               = 10*60; //10min                // The number of seconds to lockout an account due to exceeded attempts
$config['forgot_password_expiration'] = 10*60*1000; //10min     // The number of milliseconds after which a forgot password request will expire. If set to 0, forgot password requests will not expire.
...
$config['email_password'] = 'password.tpl.php';
/*
 | -------------------------------------------------------------------------
